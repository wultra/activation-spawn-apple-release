...
- PowerAuth "server stack" `2.0+` is now required
- `powerauth-mobile-sdk` v `2.0.x` is now required
- `networking-apple` v `2.0.x` is now required
- Minimal supported version of iOS raised to `13.0`
