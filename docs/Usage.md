...
```
wget https://wultra.jfrog.io/artifactory/activation-spawn-apple-release/WultraActivationSpawn-1.2.6.documentation.zip
unzip WultraActivationSpawn-1.2.6.documentation.zip -d Documentation
```